...
void FileManager::renderCurrentPath() {
  ...
  SDL_Surface *tempSurface =
      TTF_RenderText_Solid(_font, _path.string().c_str(), {255, 255, 255, 255});
...
void FileManager::renderNewFile() {
  ...
  int textWidth, textHeight;
  SDL_Surface *tempSurface =
      TTF_RenderText_Solid(_font, _file_name.c_str(), {255, 255, 255, 255});
  SDL_Texture *tempTexture =
      SDL_CreateTextureFromSurface(_renderer, tempSurface);
  SDL_QueryTexture(tempTexture, NULL, NULL, &textWidth, &textHeight);
...
bool FileManager::IsMouseOverFolderFile(
