...
void EditorWindow::render() { SDL_RenderClear(_renderer); }
...
SDL_Renderer *EditorWindow::getRenderer() const { return _renderer; }

SDL_Window *EditorWindow::getWindow() const { return _window; }
// TTF_Font *
